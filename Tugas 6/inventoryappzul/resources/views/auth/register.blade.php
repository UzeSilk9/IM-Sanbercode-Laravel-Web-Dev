...
<head>
  ...
  <title>Register to InventoryApp</title>
          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <p class="text-center">Make Your Account</p>
                <form action="/register" method="POST">
                  ...
                  <input type="submit" name="" id="" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-b-full" value="Sign Up">
